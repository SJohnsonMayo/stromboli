...
# Rev: 2016_09_22 Add load.map Rev: 2016_12_12 Reogranize rarefy,
# normalize, winsorize
load_data <- function(otu.file, map.file, tree.file = NULL, load.map = TRUE,
                      parseFunction = parse_taxonomy_greengenes, version = "Old", species = TRUE,
                      filter.no = 1, rep.seq = NULL, rff = FALSE, dep = NULL, norm = "TSS",
